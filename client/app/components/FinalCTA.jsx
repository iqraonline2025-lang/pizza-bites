        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="mt-12 flex flex-col sm:flex-row gap-4">
              <button className="px-10 py-5 bg-red-600 text-white font-black uppercase rounded-full hover:bg-white hover:text-black transition-all shadow-xl">
                Order Now
              </button>
          ...
          >
            <div className="relative w-[300px] h-[300px] md:w-[500px] md:h-[500px]">
              {/* This should be a high-quality PNG of a pizza or a phone mockup */}
              <img 
